...
import com.tresbu.nvidia.json.pojo.njob.PortDefinitions;
...
public class App {
	...
	private com.tresbu.nvidia.json.pojo.njob.Container container;
	...
	public com.tresbu.nvidia.json.pojo.njob.Container getContainer() {
		return container;
	}
	...
	public void setContainer(com.tresbu.nvidia.json.pojo.njob.Container container) {
