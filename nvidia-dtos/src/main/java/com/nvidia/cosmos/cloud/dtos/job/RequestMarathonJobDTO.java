...
public class RequestMarathonJobDTO {
	public RequestMarathonJobDTO() {
	 ...
	 *            the maxLaunchDelaySeconds to set
	 */
	 ...
	 * @param constraints
	 */
	public RequestMarathonJobDTO(String id, List<Fetch> fetch, List<PortDefinitions> portDefinitions, int cpus, String cmd, String[] uris,
			String[] args, Container container, int disk, int mem, int instances, List<List<String>> constraints) {
		super();
		this.id = id;
		this.fetch = fetch;
		this.portDefinitions = portDefinitions;
	...
	public String toString() {
		return "RequestMarathonJobDTO [id=" + id + ", fetch=" + fetch + ", portDefinitions=" + portDefinitions + ", cpus=" + cpus + ", cmd=" + cmd
				+ ", uris=" + Arrays.toString(uris) + ", args=" + Arrays.toString(args) + ", container=" + container + ", labels=" + labels
				+ ", disk=" + disk + ", mem=" + mem + ", instances=" + instances + ", constraints=" + constraints + ", backoffSeconds="
				+ backoffSeconds + ", backoffFactor=" + backoffFactor + ", maxLaunchDelaySeconds=" + maxLaunchDelaySeconds + "]";
	}
